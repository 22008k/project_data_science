...
2. **타자정보**
    - 특정 타자의 정보를 확인할 수 있습니다. 타자의 경기 통계 데이터를 볼 수 있습니다.
    - **사용 방법:**
        1. 드롭다운 메뉴에서 원하는 타자를 선택하세요.
        2. 선택한 타자의 정보를 확인하고, 버튼을 눌러 상세 정보를 볼 수 있습니다.

3. **투수정보**
    - 특정 투수의 정보를 확인할 수 있습니다. 투수의 경기 통계 데이터를 볼 수 있습니다.
    - **사용 방법:**
...
5. **NEW 지표!**
    ...
    - **사용 방법:**
        ...
        3. 선수의 BS 지표를 추측한 데이터를 막대 그래프로 시각화할 수 있습니다.

6. **미니게임**
    - 야구 시뮬레이터를 통해 선택한 타자가 되어 투구 위치, 투구 유형을 바탕으로 실제 투구 결과로 아웃 여부를 실행할 수 있습니다.
    - **사용 방법:**
        1. 드롭다운 메뉴에서 타자를 선택하세요.
        2. 3x3 그리드에서 투구 위치를 예측하세요.
        3. 라디오 버튼에서 구종 유형을 선택하세요.
