...
# Sidebar options
sidebar_options = ['사이트 설명', '야구 데이터 설명', '타자정보', '투수정보', 'vs', 'NEW 지표!', '미니게임']
...
elif selected_option == '사이트 설명':
    st.title('사이트 설명')
    st.markdown('''
## 사용 방법 안내

이 웹 애플리케이션은 다양한 야구 데이터를 제공하고, 선수 정보를 확인하거나 예측 대결, 새로운 지표 분석, 그리고 미니게임을 즐길 수 있는 기능을 갖추고 있습니다. 아래에서 각 메뉴 항목에 대한 상세 설명을 확인할 수 있습니다.

### 메뉴 항목

1. **야구 데이터 설명**
    - 각종 야구 통계 데이터를 설명합니다. 타자와 투수의 주요 지표에 대한 설명을 확인할 수 있습니다.

2. **타자정보**
    - 특정 타자의 정보를 확인할 수 있습니다. 타자의 개인 정보와 주요 경기 통계 데이터를 볼 수 있습니다.
    - **사용 방법:**
        1. 드롭다운 메뉴에서 원하는 타자를 선택하세요.
        2. 선택한 타자의 정보를 확인하고, 버튼을 눌러 상세 정보를 볼 수 있습니다.

3. **투수정보**
    - 특정 투수의 정보를 확인할 수 있습니다. 투수의 개인 정보와 주요 경기 통계 데이터를 볼 수 있습니다.
    - **사용 방법:**
        1. 드롭다운 메뉴에서 원하는 투수를 선택하세요.
        2. 선택한 투수의 정보를 확인하고, 버튼을 눌러 상세 정보를 볼 수 있습니다.

4. **vs**
    - 타자와 투수의 대결을 예측할 수 있는 기능입니다. 선택한 타자와 투수가 맞붙을 경우의 결과를 예측합니다.
    - **사용 방법:**
        1. 각각의 드롭다운 메뉴에서 타자와 투수를 선택하세요.
        2. 예측 버튼을 눌러 대결 결과를 확인할 수 있습니다.
        3. 결과는 다양한 확률 그래프로 시각화됩니다.

5. **NEW 지표!**
    - 새로운 지표 데이터를 확인할 수 있습니다. BS 지표 상위 10명을 차트로 시각화하고, BS지표와 WAR의 관계를 나타내는 그래프를 볼 수 있습니다.
    - **사용 방법:**
        1. BS 지표 데이터프레임을 확인하고, 상위 10명의 지표를 차트로 확인하세요.
        2. 선수 이름을 검색하여 해당 선수의 순위와 BS 지표를 확인할 수 있습니다.
        3. 선수의 정규화된 지표를 막대 그래프로 시각화할 수 있습니다.

6. **미니게임**
    - 야구 시뮬레이터를 통해 선택한 타자와 투구 위치, 투구 유형을 바탕으로 실제 투구 결과를 예측할 수 있습니다.
    - **사용 방법:**
        1. 드롭다운 메뉴에서 타자를 선택하세요.
        2. 3x3 그리드에서 투구 위치를 선택하세요.
        3. 라디오 버튼에서 투구 유형을 선택하세요.
        4. 예측 버튼을 눌러 결과를 확인하세요.
        5. 예측한 투구 위치와 유형이 실제 투구와 얼마나 일치하는지에 따라 다양한 타격 결과가 나옵니다.

### 시작하기

각 메뉴 항목을 클릭하여 원하는 기능을 탐색하세요. 야구 데이터를 이해하고, 선수 정보를 분석하며, 예측 대결과 미니게임을 통해 야구를 더욱 재미있게 즐기세요!
    ''')
